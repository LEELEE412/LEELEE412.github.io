...
export const projects = [
  ...
  },
  {
    ...
    categories: ['Web', 'AI'],
    period: '2025',
    role: 'SSAFY 관통 팀 프로젝트 · Full-stack 구현 참여',
    ...
    image: '/media/2025/fintrust/cover.jpg',
    imageAlt: 'FinTrust 금융상품 비교·추천 플랫폼 홈 화면',
    gallery: [
      {
        src: '/media/2025/fintrust/home-full.png',
        alt: 'FinTrust 서비스 홈과 주요 기능 소개 화면',
        caption: '서비스 홈 · 주요 기능 소개',
      },
      {
        src: '/media/2025/fintrust/products.png',
        alt: '은행과 상품 유형별 예적금 금리를 비교하는 화면',
        caption: '예·적금 상품 필터와 기간별 금리 비교',
      },
      {
        src: '/media/2025/fintrust/ai-chat.png',
        alt: '상품 비교 화면에서 열린 금융 추천 AI 챗봇',
        caption: 'OpenAI 기반 금융상품 추천 상담 인터페이스',
      },
      {
        src: '/media/2025/fintrust/community.png',
        alt: 'FinTrust 사용자 금융 커뮤니티 게시글 목록',
        caption: '게시글·댓글·대댓글을 지원하는 금융 커뮤니티',
      },
    ],
    paperUrl: '',
    videoUrl: '',
  ...
  },
  {
    ...
    index: '04',
    year: '2024',
    title: 'VR–ROS 무인보트 실시간 연동 프로토타입',
    subtitle: 'LIDAR · VR CONTROL · REAL-TIME BOAT CONNECTION',
    description:
      'LiDAR 시각화와 VR 드라이빙 조작을 Unity에 구성하고, Wi-Fi·ROS 통신으로 실제 무인보트까지 연결한 졸업논문 이전 단계의 Sim-to-Real 프로토타입입니다.',
    challenge:
      '2023년 Arduino·ESP 기반 실차–가상 차량 프로젝트에서는 제한된 메모리와 지속적인 데이터 전송 과정의 지연·누적으로 인해 안정적인 실시간 동기화에 한계가 있었습니다. 이 경험을 바탕으로 ROS 기반 데이터 흐름으로 발전시키고, LiDAR 데이터와 Unity 시뮬레이션, VR 조작 장치, 실제 보트를 하나의 과정으로 연결했습니다.\n\nUnity 수상 환경에서 HMD와 드라이빙 휠로 가상 보트를 직접 운전하고, 조작·센서 데이터를 Wi-Fi로 전달해 ROS 기반 실물 보트의 주행까지 확인했습니다. 이 단계에서 검증한 실시간 연동 구조와 문제점은 이후 실제 선체 제작과 자율주행 실험을 수행한 석사 졸업논문의 기반이 되었습니다.',
    contribution: [
      'LiDAR 포인트클라우드를 Unity에 연동해 수상 환경과 센서 인지 결과 시각화',
      'VR HMD와 드라이빙 휠을 연결한 가상 무인보트 조종 인터페이스 구현',
      'Unity의 조작·상태 데이터를 Wi-Fi 통신으로 실시간 송수신',
      'ROS 기반 제어 흐름과 실물 보트를 연결해 원격 주행 시험',
      'Arduino 기반 초기 프로토타입의 메모리·동기화 한계를 ROS 구조로 발전',
    ],
    categories: ['VR', 'Robotics', 'Digital Twin'],
    period: '2024',
    role: 'Unity/VR 개발 · ROS/Wi-Fi 연동 · 실물 주행 검증',
    technologies: ['Unity', 'ROS', 'VR HMD', 'Driving Wheel', 'LiDAR', 'Wi-Fi', 'C#'],
    achievements: [
      'LiDAR 시각화, VR 조종, 실물 보트 주행을 잇는 단계별 통합 데모 구현',
      '실시간 데이터 주기·통신 지연·동기화 문제를 확인하고 졸업논문 연구의 설계 기반 마련',
    ],
    image: '/media/2024/boat/ppt-sim-to-real-poster.jpg',
    imageAlt: 'LiDAR 시각화, VR 드라이빙 휠 기반 Unity 조종, ROS 실물 보트 주행을 연결한 세 장면',
    paperUrl: '',
    videoUrl: '/media/2024/boat/ppt-sim-to-real-overview.mp4',
    codeUrl: '',
    codeStatus: 'Private prototype',
    featured: false,
  },
  {
    ...
    index: '05',
    year: '2024',
    title: '석사 졸업논문 · Unity–ROS2 기반 무인보트 디지털 트윈',
    subtitle: 'VIRTUAL SIMULATION · EMBEDDED SYSTEM · FIELD VALIDATION',
    description:
      'Unity에서 검증한 센서·제어 구조를 실제 쌍동선 무인보트에 적용하고, 4개 임무를 40회의 수상 실험으로 검증한 석사 졸업 연구입니다.',
    challenge:
      '2023년 Arduino 기반 실물–가상 차량 프로토타입에서 확인한 메모리 사용량, 통신 지연, 실시간 데이터 동기화 문제를 새로운 설계의 출발점으로 삼았습니다. Unity에 수상 환경과 LiDAR·GPS·IMU·카메라 가상 센서를 구현해 ROS2 제어 구조를 먼저 검증하고, 동일한 메시지와 노드 구조를 실제 쌍동선 무인보트의 Jetson Nano 임베디드 시스템에 적용했습니다.\n\n선체 출력과 후가공, 방수, 부품 선정과 조립부터 Wi-Fi·DDS 통신, 센서 드라이버 연동, 자율주행 실험까지 하나의 개발 과정으로 연결했습니다. 마지막으로 25m × 15m 수조에서 GPS 경로점 주행, LiDAR 장애물 회피, 영상 기반 도킹, 통합 임무를 각각 10회씩 수행해 가상환경에서 설계한 구조가 실제 환경에서도 작동하는지 검증했습니다.',
    contribution: [
    ...
    imageAlt: '실제 수조에서 자율주행 임무를 수행하는 직접 제작한 쌍동선 무인보트',
    gallery: [
      {
    ...
    caseStudy: {
      ...
      headline: '가상에서 검증한 제어 구조를 직접 만든 무인보트에 옮겨, 물 위에서 증명하다',
      introduction: [
        '이 프로젝트는 화면 속 시뮬레이션에 머물지 않았습니다. Unity에 수상 환경과 센서를 구현하고 ROS2 자율주행 코드를 검증한 뒤, 같은 구조를 실제 소형 무인보트에 적용해 수상 임무까지 수행한 Sim-to-Real 연구입니다.',
        '선박·전기 분야의 지식을 새로 익히며 요구 전력을 계산하고 장비를 선정했습니다. 이어 3D 프린팅 출력물의 후가공과 방수, 하드웨어 조립, 센서·네트워크 연동, 현장 실험과 결과 분석까지 수행했습니다. 서로 다른 기술을 하나의 작동하는 시스템으로 연결하고 끝까지 검증한 과정이 이 연구의 핵심입니다.',
      ],
      scope: {
        direct: [
      ...
      chapters: [
        {
          ...
          title: '이전 프로토타입의 한계를 새로운 설계 조건으로 바꾸다',
          paragraphs: [
            '2023년 Arduino 기반 실물–가상 차량 프로토타입에서는 센서를 계속 전송할 때 메모리 사용량과 데이터가 누적되고, 통신 지연으로 실물과 가상 상태가 어긋나는 문제가 나타났습니다. 단순히 보드만 교체하지 않고 센서·판단·제어 기능을 노드 단위로 분리해, 가상과 실물이 같은 메시지 구조를 공유하는 Linux·ROS2 기반 시스템으로 발전시켰습니다.',
            '실제 무인보트를 구현하려면 소프트웨어 밖의 조건도 함께 해결해야 했습니다. 센서와 컴퓨팅 장치, 모터·ESC·배터리의 사양을 조사하고 전기 전공 협업자와 요구 전력을 계산했습니다. 이를 바탕으로 장비를 선정하고 구매해 구현 가능한 시스템의 범위를 구체화했습니다.',
          ],
          points: [
        ...
        },
        {
          ...
          title: '실물 적용 전에 수상 환경과 센서를 가상에서 검증하다',
          paragraphs: [
        ...
        },
        {
          number: '03',
          eyebrow: 'Sim-to-Real',
          title: '센서 인터페이스만 교체하는 Sim-to-Real 구조를 설계하다',
          paragraphs: [
        ...
        },
        {
          ...
          title: '3D 출력물을 실제로 운항할 수 있는 선체로 완성하다',
          paragraphs: [
      ...
      videos: [
        {
          ...
          description: '수상 물리와 장애물 환경, 포인트클라우드, 센서 데이터 흐름을 실물 적용 전에 확인했습니다.',
        },
        {
      ...
      resultIntro:
        '임무별 성공 기준을 먼저 정의하고 총 40회의 시험을 수행했습니다. 성공 횟수뿐 아니라 실제 환경에서 발생한 센서와 제어 문제를 함께 기록해 다음 개선 방향을 도출했습니다.',
      results: [
        {
          score: '9 / 10',
          title: 'GPS 경로점 주행',
      ...
      conclusion: {
        title: '가상 검증부터 실물 제작과 현장 실험까지 연결한 연구',
        description:
          '이 연구를 통해 가상환경에서 검증한 ROS2 제어 구조를 큰 변경 없이 실제 임베디드 시스템에 적용할 수 있음을 확인했습니다. 또한 센서 노이즈와 반사광, 통신 지연, 제어 명령 충돌처럼 실제 환경에서만 드러나는 문제를 반복 실험으로 확인했습니다. 시뮬레이션, 선체 제작, 시스템 통합, 현장 검증을 하나의 과정으로 완성한 경험을 통해 여러 기술 영역을 연결하는 시스템 개발 역량을 쌓았습니다.',
      },
    },
  },
  {
